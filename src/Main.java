...
public class Main {
	        ...
	        if (((i / 10) %10) != 0 && ((i%10) != 0) && (i%10)<=gridSize && ((i / 10) %10 <= gridSize) ) {
	            ...
	            for (int k = 1; k <= gridSize; k++) {
	                if (k != c) {
                        ...
                        //f = new And(f, new Implies(new PropositionalVariable(stri), new Not(new PropositionalVariable(str))));
	...
	public static void main(String[] args) {
		...
		/*Exemple de prédicats 
				 * 
				 *  1) Si la la valeur de la colonne est i et de la ligne j est k alors k ne doit plus apparaitre dans la même ligne
				 *  	((Xi11 => -(Xi21 || Xi31 || ...)) && ((Xi12 => -(Xi22 || Xi32 || ...)) && ... & ((Xi21 => -(Xi11 || Xi31 || ...)) ...
				 *  2) Si la la valeur de la colonne est i et de la ligne j est k alors k ne doit plus apparaitre dans la même colonne
				 *  3) Si la la valeur de la colonne est i et de la ligne j est k alors k ne doit plus apparaitre dans la même carré
				 *  4) Les cellules de colonne i et de ligne j doivent forcement contenir une valeur qui est comprise en 1 et 9 inclus.
				 */
