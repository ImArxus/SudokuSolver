...
public class Constraints {
	...
	/**
	 * Cette fonction va permettre d'ajouter a la booleanFormula en entrée toutes
	 * les conditions sur les lignes
	 * 
	 * Si la valeur de la ligne i et colomn j est k alors, k ne doit pas apparaitre
	 * sur la même ligne
	 * 
	 * Exemple : i,j,k sous la forme 111 111 -> !121 111 -> !131 111 -> !141 . . .
	 * 111 -> !191 112 -> !122 112 -> !132 . . . 999 -> !989
	 * 
	 * @param gridSize : un entier qui represente la taille de la grille
	 * @param formula  : une booleanFormula à laquel nous allons ajouter des
	 *                 conditions
	 ...
	 * sur la même colonne
	 * 
	 * Exemple : i,j,k sous la forme 111 111 -> !211 111 -> !311 111 -> !411 . . .
	 * 111 -> !911 112 -> !212 112 -> !312 . . . 999 -> !899
	 * 
	 * @param gridSize : un entier qui represente la taille de la grille
	 * @param formula  : une booleanFormula à laquel nous allons ajouter des
	 *                 conditions
	...
	/**
	 * Cette fonction va permettre d'ajouter a la booleanFormula en entrée toutes
	 * les conditions sur les carrés
	 * 
	 * Si la valeur de la ligne i et colomn j est k alors, k ne doit pas apparaitre
	 * sur le même carré
	 * 
	 * Exemple : i,j,k sous la forme 111 111 -> !121 111 -> !131 111 -> !211 111 ->
	 * !221 111 -> !231 111 -> !311 111 -> !321 111 -> !331 112 -> !122 112 -> !132
	 * . . . 999 -> !989
	 * 
	 * @param gridSize : un entier qui represente la taille de la grille
	 * @param formula  : une booleanFormula à laquel nous allons ajouter des
	...
	/**
	 * Cette fonction renvoie le numéro du carré dans lequel se trouve la case
	 * indexée
	 * 
	 * @param rowIndex    : index de la ligne pour la case souhaitée
	 * @param columnIndex : index de la colonne pour la case souhaitée
	 * @param gridSize    : taille de la grille
	 * @return le numéro du carré auquel appartient la case indexée
	 */
	...
	/**
	 * Cette fonction va permettre d'ajouter a la booleanFormula en entrée toutes
	 * les conditions sur les cellules
	 * 
	 * Si la valeur de la ligne i et colomn j est k alors, toutes les autres valeurs
	 * ne sont pas autorisés pour cette cellule
	 * 
	 * Exemple : i,j,k sous la forme 111 111 -> !112 111 -> !113 111 -> !114 111 ->
	 * !115 111 -> !116 111 -> !117 111 -> !118 111 -> !119 112 -> !111 112 -> !113
	 * . . . 999 -> !998
	 * 
	 * @param gridSize : un entier qui represente la taille de la grille
	 * @param formula  : une booleanFormula à laquel nous allons ajouter des
